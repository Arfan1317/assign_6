      ...
      <footer className="w-full bg-[#0f172a] pt-20 pb-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-12 gap-8 pb-20 w-full">
            ...
            <div className="col-span-2">
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Features</a></li>
                <li><a href="#pricing" className="text-slate-400 hover:text-white transition-colors text-[15px]">Pricing</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Templates</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Integrations</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-2">
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">About</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Blog</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Careers</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Press</a></li>
              </ul>
            </div>
            ...
            <div className="col-span-2">
              ...
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Documentation</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Help Center</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Community</a></li>
                <li><a href="#" className="text-slate-400 hover:text-white transition-colors text-[15px]">Contact</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-row gap-8 text-[14px]">
